...
CREATE TABLE `tbl_info_familiar` (
  ...
  `depende_ec` int(11) DEFAULT NULL,
  `fecha_registro` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `fk_info_familiar_usuario` (`id_usuario`),
  KEY `fk_info_familiar_contacto` (`personas_casa`),
  CONSTRAINT `fk_info_familiar_contacto` FOREIGN KEY (`personas_casa`) REFERENCES `tbl_contacto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `tbl_info_personal` VALUES (2,43,'victor ','Mejia','CC','10171','2026-02-04 00:00:00',NULL,'','','','','',NULL,'','','','','','','',NULL,'2026-08-03 10:16:54',NULL,NULL);
...
-- Dump completed on 2026-08-14 12:43:01
